...
export default function Login({ error, onSubmit, onRegister }) {
  return (
    <>
      <div className="form-heading"><p className="eyebrow">Welcome</p><h2>Sign in to your portal</h2><p>Continue where you left off.</p></div>
      <div className="mode-switch" role="tablist"><button className="active">Sign in</button><button onClick={onRegister}>Register</button></div>
